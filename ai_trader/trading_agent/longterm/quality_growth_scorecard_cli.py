"""CLI for deterministic quality-growth scorecard enrichment."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Add deterministic quality-growth scorecards to enriched ideas.")
