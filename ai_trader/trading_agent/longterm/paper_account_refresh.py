...
def refresh_paper_account_artifacts(
    *,
    ...
    scheduler_launch_packet_path: str | Path = "",
    scheduler_no_submit_smoke_path: str | Path = "",
    research_queue_summary_path: str | Path = "",
    scheduler_soak_plan_path: str | Path = "",
    ...
    manifest = build_dashboard_manifest(
        ...
        scheduler_launch_packet=scheduler_launch_packet_path,
        scheduler_no_submit_smoke=scheduler_no_submit_smoke_path,
        research_queue_summary=research_queue_summary_path,
        scheduler_soak_plan=scheduler_soak_plan_path,
    ...
    summary = {
        ...
        "components": {
            ...
            "scheduler_launch_packet": _component(scheduler_launch_packet_path),
            "scheduler_no_submit_smoke": _component(scheduler_no_submit_smoke_path),
            "research_queue_summary": _component(research_queue_summary_path),
            "scheduler_soak_plan": _component(scheduler_soak_plan_path),
